...
'''
    For Whoever is reading this for CS-216. I took this code from Choy's Github in order to read binvox files.
    This was something I did not want to implement myself and give all credit to Choy.
'''
